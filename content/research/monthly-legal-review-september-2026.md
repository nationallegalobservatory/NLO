---
slug: "monthly-legal-review-september-2026"
type: "research"
format: "monthly-report"
title: "Monthly Legal Review — Vol. 1 | Issue 4 | September 2026"
author: "bhoomija-khanna"
date: "2026-09-26"
publishAt: "2026-09-26T18:00:00+05:30"
categories: ["constitutional-law", "technology-law", "criminal-law", "corporate-law", "public-policy"]
tags: ["Monthly Review", "Supreme Court", "Balaji Formalin", "Proportionality", "POCSO Act", "Reverse Burden", "Cess Reference", "Parliament", "Supreme Court Strength", "TRAI", "A2P", "Legal Metrology", "Indian Standard Time"]
abstract: "The September 2026 Monthly Legal Review from the National Legal Observatory analyses the Supreme Court's landmark judgment in M/s Balaji Formalin Pvt. Ltd. v. Union of India (2026 INSC 1009) applying Puttaswamy proportionality to industrial trade restrictions, clarification of POCSO's rebuttable presumption in Deepak in JC v. State (2026 INSC 1008), the Seven-Judge Constitution Bench reserving verdict on State additional sales tax and cess powers, legislative implementation of Supreme Court sanctioned strength expansion to 38 judges, TRAI's new A2P robocall regulations, the Legal Metrology Indian Standard Time mandate, and an Editor's Note on proportionality's quiet expansion across commercial jurisprudence."
citation: "Bhoomija Khanna (ed.), 'Monthly Legal Review — Vol. 1, Issue 4, September 2026', National Legal Observatory (September 2026)."
coverImage: ""
---
...
**Volume 1 | Issue 4 | September 2026**
...
- **Judgment of the Month:** [M/s Balaji Formalin Pvt. Ltd. v. Union of India (2026 INSC 1009)](#01--judgment-of-the-month)
- **Constitutional Watch:** [POCSO's Rebuttable Presumption | The Seven-Judge Cess Reference](#02--constitutional-watch)
- **Legislative Tracker:** [Monsoon Session Aftermath | Supreme Court Strength at 38 | FCRA Bill in Committee](#03--legislative-tracker)
- **Policy Pulse:** [TRAI's A2P Robocall Rules | The Indian Standard Time Mandate](#04--policy-pulse)
- **Editor's Note:** [Proportionality's Quiet Takeover](#05--editors-note)
...
The Bench went further and issued guidelines, binding on States and Union Territories, calling for border monitoring of liquor transport, industrial solvent tracking, dedicated logistics for methanol shipments, and expanded de-addiction healthcare. On prohibition itself, the Court was blunt: total bans have historically driven the liquor trade underground rather than eliminating it, and Gujarat's own experience as a dry State was cited as the example.

#### Why This Matters

This is a chemical-safety regulation decided with the analytical machinery built for privacy law. *Puttaswamy*'s proportionality test, until now mostly seen in cases about surveillance, Aadhaar, and internet shutdowns, has just been used to strike down a state subordinate-legislation rule governing industrial solvent sales. Any state measure that burdens Article 19(1)(g) commerce—licensing regimes, transport permits, sin-good taxation—can now be tested not just for reasonableness but for whether the state can show, with evidence, that less restrictive alternatives were considered and that the measure it chose actually works. For prohibition-style laws across India's dry States, and for regulators who have leaned on symbolic compliance requirements rather than enforcement, that is a considerably higher bar.

---

## 02 | CONSTITUTIONAL WATCH

### Key Developments at the Supreme Court | September 2026
...
POCSO's presumption clauses exist because child sexual abuse is hard to prove and children make imperfect witnesses. That is a real and serious problem. But presumption-heavy statutes—POCSO, NDPS, UAPA—all carry the same risk: that a presumption becomes a substitute for evidence rather than a supplement to it. This judgment draws that line explicitly, in a case where getting it wrong would have kept an innocent man in prison for years longer. Practitioners on both sides of the POCSO docket will be citing it.
...
The stakes are structural. GST occupied most of the field states used to tax independently. A ruling that confirms broad state power to layer additional cesses on remaining sales-tax heads would hand states a fiscal tool they have not meaningfully used in over two decades. A ruling the other way forecloses it for good. NLO will report the outcome as soon as it is delivered.
...
#### 3. FCRA Amendment: Parked in Committee

*Foreign Contribution (Regulation) Amendment Bill, 2026 | Status: Referred to Joint Parliamentary Committee*

The Bill, which would cut the maximum jail term for FCRA violations from five years to one and create a dedicated framework for winding up the assets of organisations that lose FCRA registration, was referred to committee rather than passed. It remains the session's most consequential unfinished business, and the one most likely to resurface first when Parliament reconvenes.

---

## 04 | POLICY PULSE

### Executive and Regulatory Developments | September 2026
...
### Proportionality's Quiet Takeover

*By Bhoomija Khanna, Research Director*

*Balaji Formalin* is, on its face, a case about methanol. Read the judgment closely and it is a case about which legal test the Supreme Court now reaches for whenever a state tries to restrict commerce, and that question is bigger than one chemical rule in one state.

The four-part proportionality test—legitimate aim, suitability, necessity, balancing—entered Indian constitutional law properly in *Modern Dental College* (2016) and was cemented as the standard for reviewing rights-restricting state action in *Puttaswamy* (2017). Both cases were fundamentally about privacy: what the state may know about a citizen, and on what terms. The test was built for that specific question, where the state's justification for an intrusion has to be weighed against a right most people intuitively understand as demanding a high threshold.
...
Every prohibition law in every dry State in India now sits under a live question this judgment did not ask out loud: does it survive the same test? Gujarat's blanket ban is referenced in the judgment itself, as a cautionary example, not a defendant. The next petitioner challenging a dry-state law now has a Supreme Court precedent applying rigorous proportionality review to alcohol regulation specifically. Whether that is a feature or a problem depends on which side of that challenge you expect to be on. Either way, the doctrine's boundaries needed clarifying before this case, not after it.
...
1. [Verdictum — M/s Balaji Formalin Pvt. Ltd. v. Union of India, 2026 INSC 1009](https://www.verdictum.in/supreme-court/2026-insc-1009-balaji-formalin-pvt-v-union-of-india-1622297)
2. [Supreme Court Observer — SCO.LR 2026 9(3)[13], Validity of Maharashtra's Methanol Regulation](https://www.scobserver.in/supreme-court-observer-law-reports-scolr/validity-of-maharashtras-methanol-regulation/)
3. [Raw Law — Full case analysis, Balaji Formalin v. Union of India](https://rawlaw.in/maharashtra-orders-bitterant-and-colourant-in-methanol-to-prevent-hooch-deaths-supreme-court-strikes-down-rules-as-arbitrary-and-disproportionate/)
4. [ThePrint — SC suggests multi-department strategy to prevent hooch tragedies](https://theprint.in/india/sc-suggests-multi-department-strategy-to-prevent-hooch-tragedies/3046638/)
5. [IntoLegalWorld — Manifestly arbitrary: Supreme Court strikes down Maharashtra's methanol rule](https://www.intolegalworld.com/post/manifestly-arbitrary-supreme-court-strikes-down-maharashtra-s-14-year-methanol-denaturing-rule-that)

### Constitutional Watch
6. [LiveLaw — Presumption of guilt under POCSO not absolute: Supreme Court acquits man](https://www.livelaw.in/supreme-court/presumption-of-guilt-under-pocso-act-not-absolute-supreme-court-acquits-man-550578)
7. [SCC Online Blog — POCSO presumptions rebuttable: Deepak in JC v. State](https://www.scconline.com/blog/post/2026/09/19/pocso-presumptions-rebuttable-sc-penetrative-sexual-assault-convict-acquitted/)
8. [The Indian Lawyer — Supreme Court on Section 29 of POCSO](https://theindianlawyer.in/supreme-court-on-section-29-of-pocso-presumption-of-guilt-cannot-replace-proof/)
9. [Business Standard — SC reserves verdict on states' power to impose additional tax, surcharge](https://www.business-standard.com/amp/companies/news/sc-reserves-verdict-on-states-power-to-impose-additional-tax-surcharge-126092201306_1.html)

### Legislative Tracker
10. [LiveLaw — Parliament Monsoon Session 2026 Recap: 12 Bills Passed](https://www.livelaw.in/news-updates/monsoon-session-parliament-2026-12-bills-passed-lok-sabha-rajya-sabha-545997)
11. [SCC Online Blog — 19 Sittings, 11 New Laws: Parliament's Monsoon Session 2026](https://www.scconline.com/blog/post/2026/08/21/parliament-monsoon-session-2026-key-acts-bills/)
12. [Business Standard — Parliament Monsoon Session: 12 Bills introduced, 11 passed](https://www.business-standard.com/amp/india-news/parliament-monsoon-session-12-bills-introduced-11-passed-33-hrs-spent-126081300890_1.html)
13. [LawBeat — Rajya Sabha passes Bill to increase Supreme Court judge strength from 34 to 38](https://lawbeat.in/top-stories/rajya-sabha-passes-bill-to-increase-supreme-court-judge-strength-from-34-to-38-1619488)
14. [Open Magazine — Monsoon Session 2026: Government to push key Bills](https://openthemagazine.com/india/government-to-push-7-bills-in-monsoon-session-focus-on-legacy-laws)

### Policy Pulse
15. [Blitz India Media — India Government Updates: Telecom, Railways, Sugar, Defence](https://blitzindiamedia.com/news/india-government-policy-updates-september-2026/)
16. [Legacy IAS Academy — Current Affairs 01 September 2026, Legal Metrology (IST) Rules](https://www.legacyias.com/current-affairs-01-september-2026/)

### Editor's Note — Background Reading
17. [Law and Other Things — Confused and Confusing: Proportionality in the Supreme Court's FCRA Judgment](https://lawandotherthings.com/confused-and-confusing-proportionality-in-the-supreme-courts-fcra-judgment/)
18. [Oxford Human Rights Hub — Proportionality in Theory, Not Practice: Internet Rights in Indian Courts](https://ohrh.law.ox.ac.uk/proportionality-in-theory-not-practice-internet-rights-in-indian-courts/)
19. [Indian Constitutional Law and Philosophy — Proportionality (category archive)](https://indconlawphil.wordpress.com/category/constitutional-interpretation/proportionality/)
20. [Supreme Court Observer — Cabinet clears Bill to expand Supreme Court strength](https://www.scobserver.in/journal/cabinet-clears-bill-to-expand-supreme-court-strength-to-38-judges/)

## PUBLICATION NOTICE

*© 2026 National Legal Observatory | legal-observatory.vercel.app | Vol. 1 Issue 4*  
